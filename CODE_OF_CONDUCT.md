...
* **Learn Continuously**: Be open to learning from mistakes
...
* **Risk Disclosure**: Always emphasize the risks of algorithmic trading
* **No Guarantees**: Never guarantee profits or specific returns
* **Responsible Use**: Promote responsible testing and paper trading first
* **Security First**: Never share API keys, credentials, or sensitive data
* **Legal Compliance**: Respect all applicable securities and trading regulations
...
As this is a trading platform project:

* Contributors must disclose any financial conflicts of interest
* Do not use the project to manipulate markets or securities
* Do not coordinate trading activities through project channels
* Respect all securities laws and regulations in your jurisdiction
